...
const COFFEE_ITEMS_STORAGE_KEY = "coffeeDelivery:cartItem"
...
export function CartContextProvider({ children }: CartContextProviderProps){
  ...
  return(
    <CartContext.Provider value={{cartItems,addCoffeeToCart,cartQuantity,changeCartItemQuantity,removeCartItem,cartItemsTotal,cleanCart}}>
      {children}
